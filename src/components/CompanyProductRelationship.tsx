            ...
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              ...
              <div>
                <p className="text-lg leading-8 text-gray-700">
                  ...
                  document processing, search, citation-backed AI model serving,
                  compliance monitoring, alerts, and secure institutional
                  workflows.
                </p>
                ...
                <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {infrastructureUses.map((item) => (
                    ...
                    >
                      ...
                      <p className="text-sm font-medium leading-6 text-brand-gray">
                        {item.label}
                      </p>
                    </div>
                  ))}
                ...
                <p className="mt-8 rounded-lg border border-brand-blue/20 bg-white p-4 text-sm font-semibold leading-6 text-brand-gray">
                  This is the company-product relationship: magentiqlabs.com is
                  the company domain for Magentiq AI Labs Ltd.; lawlens.io is
                  the product domain for Law Lens Uganda.
                </p>
              </div>
            </div>
          </div>
